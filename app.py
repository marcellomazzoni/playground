...
if st.session_state.get("sup_unsup_button") == "Supervised":
    ...
    if st.session_state.get("confirmed"):
         pages["Clustering methods"] = [
                ...
                st.Page("unsupervised_models/DBSCAN.py",           title="DBSCAN",  icon=":material/grain:"),
                st.Page("unsupervised_models/Hierarchical.py",     title="Hierarchical",  icon=":material/mediation:"),
                ]
